...
import { Container, Button, Dialog, DialogActions, DialogContent, DialogTitle, TextField, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, CircularProgress } from "@mui/material";
...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(error.response ? error.response.data.message : 'Failed to create user.');
    } finally {
      setLoading(false);
    }
  };
